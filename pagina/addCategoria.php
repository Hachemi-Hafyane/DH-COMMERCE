...
<html lang="pt-br">
  ...
  <body>
    <h class="container">
      <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
              <a class="nav-link active" href="addCategoria.php">Adicionar Categoria</a>
            </li>
            <li class="nav-item">
      ...
      <form action="../DB/cadCategoria.php" method="post" class="shadow p-4 rounded mt-5" style="width:90%;max-width: 50rem ;">
      <?php 
				if(isset($_GET['error'])){
			?>
